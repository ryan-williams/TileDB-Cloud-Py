...
import tiledb
import tiledb_cloud.utilities.logging
...
def get_logger_wrapper(*args, **kwargs):
    warnings.warn(
        ...
        "use tiledb_cloud.utilities.logging.get_logger_wrapper() instead.",
        DeprecationWarning,
        stacklevel=2,
    )
    return tiledb_cloud.utilities.logging.get_logger_wrapper(*args, **kwargs)
