...
import tiledb
import tiledb_cloud._common.api_v2.models as models_v2
import tiledb_cloud.rest_api.models as models_v1
from tiledb_cloud import config
from tiledb_cloud import rest_api
from tiledb_cloud import tiledb_cloud_error
from tiledb_cloud.pool_manager_wrapper import _PoolManagerWrapper
from tiledb_cloud.rest_api import ApiException as GenApiException
...
def login(
    ...
    :param host: host to login to. the tiledb_cloud.regions module contains
...
class Client:
    ...
    def build(self, builder: Callable[[rest_api.ApiClient], _T]) -> _T:
        ...
        if builder.__module__.startswith("tiledb_cloud._common.api_v2"):
