...
from tiledb_cloud.compute import DelayedMultiArrayUDF
...
def build_read_dag(
    ...
    *,
    ...
    verbose: bool = False,
) -> Tuple[tiledb_cloud.dag.DAG, tiledb_cloud.dag.Node]:
    """
        ...
        for sample in range(num_sample_partitions):
            tables.append(
                dag.submit(
                    ...
                    result_format=tiledb_cloud.UDFResultType.ARROW,
                )
            )
