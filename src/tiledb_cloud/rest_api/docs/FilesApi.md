# tiledb_cloud.rest_api.FilesApi
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.FilesApi(api_client)
    namespace = 'namespace_example' # str | The namespace of the file
file_create = tiledb_cloud.rest_api.FileCreate() # FileCreate | Input/Output information to create a new TileDB file
...
file_export = tiledb_cloud.rest_api.FileExport() # FileExport | Export configuration information
