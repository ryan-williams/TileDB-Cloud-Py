...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.UserApi(api_client)
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tiledb_cloud.rest_api.UserApi(api_client)
    user = tiledb_cloud.rest_api.User() # User | user to create
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tiledb_cloud.rest_api.UserApi(api_client)
    token_request = tiledb_cloud.rest_api.TokenRequest() # TokenRequest | token request object (optional)
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = tiledb_cloud.rest_api.UserApi(api_client)
    user = tiledb_cloud.rest_api.InlineObject() # InlineObject |
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.UserApi(api_client)
    username = 'username_example' # str | username or ID
user = tiledb_cloud.rest_api.User() # User | user details to update
