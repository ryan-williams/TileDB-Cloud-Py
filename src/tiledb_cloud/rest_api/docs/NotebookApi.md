# tiledb_cloud.rest_api.NotebookApi
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.NotebookApi(api_client)
...
notebook_copy = tiledb_cloud.rest_api.NotebookCopy() # NotebookCopy | Input/Output information to create a new TileDB file
...
notebook_metadata = tiledb_cloud.rest_api.ArrayInfoUpdate() # ArrayInfoUpdate | notebook (array) metadata to update
