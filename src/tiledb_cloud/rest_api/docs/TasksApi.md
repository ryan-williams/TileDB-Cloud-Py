# tiledb_cloud.rest_api.TasksApi
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.TasksApi(api_client)
    namespace = 'namespace_example' # str | namespace to run task under is in (an organization name or user's username)
sql = tiledb_cloud.rest_api.SQLParameters() # SQLParameters | sql being submitted
