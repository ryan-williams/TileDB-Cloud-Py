# tiledb_cloud.rest_api.GroupsApi
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.GroupsApi(api_client)
...
group_changes = tiledb_cloud.rest_api.GroupChanges() # GroupChanges |  (optional)
...
group_create = tiledb_cloud.rest_api.GroupCreate() # GroupCreate |  (optional)
...
group_register = tiledb_cloud.rest_api.GroupRegister() # GroupRegister |  (optional)
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    group_namespace = 'group_namespace_example' # str | The namespace of the group
group_name = 'group_name_example' # str | The unique name or id of the group
group_update = tiledb_cloud.rest_api.GroupUpdate() # GroupUpdate |  (optional)
