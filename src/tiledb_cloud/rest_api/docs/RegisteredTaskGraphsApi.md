# tiledb_cloud.rest_api.RegisteredTaskGraphsApi
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    api_instance = tiledb_cloud.rest_api.RegisteredTaskGraphsApi(api_client)
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    namespace = 'namespace_example' # str | The namespace that owns this registered UDF.
name = 'name_example' # str | The name of the registered task graph.
graph = tiledb_cloud.rest_api.RegisteredTaskGraph() # RegisteredTaskGraph | Task graph to register. (optional)
...
with tiledb_cloud.rest_api.ApiClient(configuration) as api_client:
    ...
    namespace = 'namespace_example' # str | The namespace that owns this registered UDF.
name = 'name_example' # str | The name of the registered task graph.
graph = tiledb_cloud.rest_api.RegisteredTaskGraph() # RegisteredTaskGraph | The new contents of the task graph. (optional)
